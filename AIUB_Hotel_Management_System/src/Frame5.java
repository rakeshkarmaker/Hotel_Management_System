...
public class Frame5 extends JFrame implements ActionListener, MouseListener,KeyListener
{
    ...
    Frame5(float finalCost, CheckOutCalculator calcObj)
    {
        ...
        System.out.println("Final cost at frame 5 constructor: "+finalCost);
        System.out.println("Total cost at frame 5 constructor: "+calcObj.getTotalCost());
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        }else if(genderComboBox.getSelectedIndex()==3){
            gGeneder = "Other";
        ...
        guest.setGuestGender(gGeneder);
        guest.setGuestAgeType(String.valueOf(genderComboBox.getSelectedIndex()));
        guest.settTotalCost(finalCost);
        ...
        {
            Frame7 f7=new Frame7(finalCost,calcObj);
            System.out.println("Final cost at frame 5:"+finalCost);
//            f7.setFinalCost(finalCost);
            System.out.println("Total cost at frame 5:"+calcObj.getTotalCost());
//            f7.setCostCalculatorObject(calcObj);
            f7.setGuestObject(  guest );
            f7.setVisible(true);
            this.setVisible(false);
