...
public class Frame4 extends JFrame implements ActionListener,MouseListener
{
    ...
    protected float finalCost = 0.00F;

    CheckOutCalculator setCalcObj;
    ...
    public void  costCalc(){
        ...
        finalCost = calcObj.getTotalCost();
        totalCost.setText(String.valueOf(calcObj.getTotalCost()));
        setCalcObj = calcObj;
        System.out.println("Final cost at frame 4 "+finalCost);
        System.out.println("Total cost at frame 4 "+totalCost.getText());
    }
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if(ae.getSource()==back) {
            ...
            costCalc();
            Frame5 f5=new Frame5(finalCost, setCalcObj);
//            f5.setFinalCost(finalCost);
//            f5.setCostCalculatorObject(setCalcObj);
            f5.setVisible(true);
            this.setVisible(false);
        ...
        if (royalSuite.isSelected()==true){ //Room selection
            roomIndex = 0;
            acIndex = 1;
            ac.setSelected(true);
            costCalc();
