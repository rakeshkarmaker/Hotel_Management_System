...
public class Frame7 extends JFrame implements ActionListener, MouseListener // IObjectpass, IcalcObj
{
    ...
    public void setFinalCost(float finalCost) {this.finalCost = finalCost;}
    void setCostCalculatorObject(CheckOutCalculator calcObj){this.calcObj = calcObj;}
    void setGuestObject( Guest guest ){
        this.guest  = guest;
    }

    Frame7(float finalCost, CheckOutCalculator calcObj) {
        ...
        System.out.println("Final cost at frame 7 constructor: "+finalCost);
        System.out.println("Total cost at frame 7 constructor: "+calcObj.getTotalCost());
        ...
        System.out.println("Total room cost: "+calcObj.getTotalCost());
        roomCostTextField=new JTextField(String.valueOf(calcObj.getTotalCost()));
        ...
        grandTotalTextField=new JTextField(String.valueOf(finalCost));
    ...
    public void actionPerformed(ActionEvent ae)
	{
        ...
        {
            Frame5 f5=new Frame5(finalCost, calcObj);
            f5.setVisible(true);
