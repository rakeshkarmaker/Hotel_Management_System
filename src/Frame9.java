...
public class Frame9 extends JFrame implements ActionListener,MouseListener
{
    JLabel label,bgimg,searchEmployeeLabel;
    ...
    Frame9() {
        super("Frame9 Employee Management");
        ...
        img=new ImageIcon(this.getClass().getResource("Frame9.jpg"));
        bgimg=new JLabel(img);
        bgimg.setSize(this.getSize());
        panel.add(bgimg);

        label=new JLabel("Employee Management");
        label.setBounds(280,30,500,30);
        label.setForeground(Color.white);
        label.setFont(new Font("Script MT Bold",Font.PLAIN,40));
        bgimg.add(label);

        searchEmployeeLabel=new JLabel("Search Employee: ");
        searchEmployeeLabel.setBounds(100,125,350,30);
        searchEmployeeLabel.setForeground(Color.white);
        searchEmployeeLabel.setFont(new Font("Times New Roman",Font.PLAIN,23));
        bgimg.add(searchEmployeeLabel);
