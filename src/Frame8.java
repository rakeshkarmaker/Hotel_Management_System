...
public class Frame8 extends JFrame implements ActionListener, MouseListener
{
    ...
    Frame8(CheckOutCalculator calcObj, Guest guest) {
        super("Frame8 Bill");
        ...
        nameTextField=new JTextField(guest.getGuestName());
        ...
        phnNumberTextField=new JTextField(guest.getGuestPhoneNumber());
        ...
        nameTextField=new JTextField(guest.getGuestGender());
        ...
        addressTextField=new JTextField(guest.getGuestAddress());
        ...
        roomNumberTextField=new JTextField("DS0"+random.nextInt(3000));
        ...
        totalBillTextField=new JTextField(String.valueOf(calcObj.getTotalCost()));
        ...
        billNoLabel=new JLabel("Booking time: ");
        ...
        billNoTextField=new JTextField(guest.getCheckInTime());
        billNoTextField.setBounds(630,350,180,30);
        ...
        billNoLabel=new JLabel("CheckOut time: ");
        billNoLabel.setBounds(490,390,200,35);
        billNoLabel.setForeground(Color.MAGENTA);
        billNoLabel.setFont(new Font("Times New Roman",Font.BOLD,20));
        bgImgLabel.add(billNoLabel);

        billNoTextField=new JTextField(guest.getCheckOutTime());
        billNoTextField.setBounds(630,390,180,30);
        billNoTextField.setFont(new Font("Times New Roman",Font.BOLD,17));
        billNoTextField.setEditable(false);
        billNoTextField.setEditable(false);
        bgImgLabel.add(billNoTextField);
        ...
        changTextField=new JTextField(String.valueOf(calcObj.getChangeCalculator()));
