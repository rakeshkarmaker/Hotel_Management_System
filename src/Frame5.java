...
public class Frame5 extends JFrame implements ActionListener, MouseListener,KeyListener
{
  ...
  /*
    ...
    public void setCostCalculatorObject(CheckOutCalculator calcObj) {
        this.calcObj = calcObj;
    }*/

    Frame5(CheckOutCalculator setCalcObj, Guest guest) {
        super("Frame5 Room Booking");
        this.setSize(900, 600);
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

        this.calcObj = setCalcObj;
        this.guest = guest;
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        if(genderComboBox.getSelectedIndex()==0) {
            gGeneder = "Male";
            System.out.println(genderComboBox.getSelectedIndex());
        ...
        else if(ae.getSource()==next)
        {
            ...
            guest.setGuestName( nameTextField.getText() );
            ...
            guest.settTotalCost(calcObj.gettTotalCost());

            Frame7 f7=new Frame7(calcObj,guest);
