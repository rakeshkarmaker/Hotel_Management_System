...
import com.classes.HotelManagementSystem;
...
public class Frame7 extends JFrame implements ActionListener, MouseListener // IObjectpass, IcalcObj
{
    ...
    JPanel panel;
    CheckOutCalculator calcObj;
    Guest guest ;
    float finalCost;

    Frame7(CheckOutCalculator calcObj,Guest guest) {
        ...
        roomCostTextField=new JTextField(String.valueOf(calcObj.GetRoomCost()));
        ...
        serviceCostLabel=new JLabel("Total Service Cost");
        ...
        serviceCostTextField=new JTextField(String.valueOf(calcObj.getServiceCost()));
        ...
        vatTextField=new JTextField(String.valueOf(calcObj.getVAT()));
        ...
        discountTextField=new JTextField("Null");
        ...
        grandTotalTextField=new JTextField(String.valueOf(calcObj.getTotalCost()));
    ...
    public void actionPerformed(ActionEvent ae)
	{
        ...
        {
            Frame5 f5=new Frame5(calcObj,guest);
            f5.setVisible(true);
            this.setVisible(false);
        }
        else if(ae.getSource()==next)
        {
            if( calcObj.gettTotalCost() <= Float.parseFloat(paymentTextField.getText())) {
                calcObj.setChangeCalculator(Float.parseFloat(paymentTextField.getText()));

                Frame8 f8 = new Frame8(calcObj, guest);
                f8.setVisible(true);
                this.setVisible(false);

                HotelManagementSystem hmsObject = new HotelManagementSystem();
                hmsObject.guestCheckIn(guest);
            }
        }
    }
